...
export default function DrivingLicenseBottomSheet({
  visible,
  onClose,
  ...
  const onSubmit = async () => {
    ...
    try {
      const response = await updateDocumentsMutation.mutateAsync({
        ...
        driverLicenseFrontUri: picker.frontUri ?? undefined,
        driverLicenseBackUri: picker.backUri ?? undefined,
      });
    ...
    <ProfileBottomSheetBase visible={visible} onClose={onClose} title={t('profile_driving_license')}>
      <View style={styles.content}>
        ...
        <TextInput
          ...
          placeholder={t('profile_license_no_value')}
